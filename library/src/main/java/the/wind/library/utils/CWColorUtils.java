...
public final class CWColorUtils {
    ...
    public static String[] POKE_COLORS = {
            ...
            "#9c3546", "#92527f", "#8a8586", "#ac869c", "#85c476", "#66758c", "#b18eaa", "#bbb4a7", "#a49485", "#9cbfd6",
            "#bd4934", "#216f91", "#98acbc", "#2d87c2", "#805877", "#83a3b7", "#ece4c4", "#d6c68c", "#ecdedb", "#4a6caa",
            "#d36754", "#7a5c94", "#879285", "#647483", "#ddb7c9", "#9060a4", "#9284bd", "#afc3c7", "#549e7a", "#d45270",
            ...
            "#3c5d74", "#e1dbe4", "#919faa", "#dce8d8", "#c1a8b2", "#93c39c", "#d483a1", "#7299be", "#ae4b61", "#bfcabb",
            ...
            "#e0dee2", "#7c7d7c", "#4d6b86", "#c9733b", "#ddd7e0", "#56bc7c", "#65aad0", "#746e7c", "#77638d", "#c49450",
            "#819353", "#cebacf", "#d76272", "#87c5e8", "#717481", "#a395c2", "#d7daa4", "#c8deea", "#f39454", "#abaa56",
            "#d1a5af", "#f3eabc", "#accc71", "#c3b7a7", "#546f8f", "#c49059", "#cd9e39", "#487288", "#f4e197", "#dbe1e7",
            ...
            "#d3cf99", "#e5ded3", "#ae784a", "#968493", "#c3a5ae", "#e7ca86", "#94705b", "#6a959d", "#afc579", "#bcbcdc",
            "#e3dedd", "#c29237", "#5b93c8", "#d89b96", "#917788", "#baaccc", "#d0d8db", "#e0a6be", "#71aa78", "#dbd0bc",
            "#60b949", "#a7ce86", "#7ab5c8", "#b58b79", "#44586b", "#d6d7d8", "#eff5f6", "#a397b2", "#e8e9e4", "#b9ab82",
            "#f2f294", "#b7d6cf", "#9f6e62", "#7a9e9f", "#8a70a0", "#74b4b3", "#e7e7e5", "#416368", "#d2594e", "#a5b0b1",
            "#eddee0", "#bcdcdf", "#bf8d9a", "#d7dfe6", "#b294bf", "#8f715b", "#c1a27f", "#d6856c", "#e18b6b", "#e1dfd4",
            "#d1ebf6", "#cadfb3", "#d3d5da", "#e4d34e", "#d66a56", "#b380b2", "#5b5a6b", "#e5754b", "#d1c7ca", "#c5cdd2",
            ...
            "#e0d4d5", "#b4be8a", "#a1b6b6", "#c9a849", "#afbdb2", "#6eb1d7", "#e1e9c9", "#838636", "#ee702f", "#dbf3eb",
            ...
            "#a37e55", "#74a5c4", "#bdb97d", "#8d7273", "#de8e59", "#93af4b", "#9ca772", "#9a545e", "#b3bb96", "#99bfa1",
            "#5fa754", "#a2514b", "#f3b383", "#a1b881", "#71b09c", "#dadadc", "#e3e9d8", "#bfb1a2", "#a7b492", "#f2d0a2",
            "#e9ebd2", "#ecefe6", "#4f5e7c", "#c4be9c", "#9b8f4e", "#abb965", "#767778", "#d2d7dd", "#70b8c7", "#e18a62",
            ...
            "#b87e65", "#8fbb7d", "#aaacbe", "#456276", "#d0dde4", "#44657f", "#9cd2dd", "#81715e", "#cfdf73", "#c7dfcb",
            ...
            "#9cc4a5", "#64acbc", "#c5bec8", "#96bacf", "#6c94a4", "#d4d0d0", "#9ca8ac", "#547d93", "#94748e", "#b366a1",
            ...
            "#dcbb5b", "#97c03f", "#675f5b", "#486273", "#cbc9c5", "#e5d2c1", "#b2a6b3", "#93b67c", "#3689bc", "#eec09d",
            ...
            "#73c6da", "#d0dbdb", "#e2a24a", "#f4d974", "#e1e886", "#c8506b", "#678283", "#97713d", "#dca9b5", "#bdb58b",
            "#e5ddd9", "#d5dd8f", "#c4b5d4", "#436ca4", "#e0a888", "#875b74", "#c7ccb3", "#94a4aa", "#84ccdc", "#8891a2",
            "#97c03b", "#ccda85", "#9dbea5", "#969daa", "#6eb2cb", "#b3bda6", "#d3d3e4", "#aeb8b9", "#5a6a81", "#74afb0"
    };
